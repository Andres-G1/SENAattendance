  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (err.response?.status === 400) {
        ...
        setError(err.response?.data?.detail || "No se pudo registrar el instructor.");
      }
    } finally {
      setGuardando(false);
    }
    ...
    <main className="container my-5">
      <div className="page-card card shadow-sm" style={{ maxWidth: "700px", margin: "0 auto" }}>
        <div className="card-header bg-success text-white py-3">
          <h1 className="h5 mb-0">Crear Nuevo Instructor</h1>
        </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="d-flex gap-2 mt-4">
              <button type="submit" className="btn btn-success" disabled={guardando}>
                {guardando ? "Registrando..." : "Registrar Instructor"}
              </button>
