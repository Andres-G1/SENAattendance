...
import { desactivarInstructor, activarInstructor } from "../../services/api";

export default function ConfirmarInstructor() {
  const { id } = useParams();
  ...
  const nombre = state?.nombre || "este instructor";
          ...
          <div className="bg-white p-4">
            <p className="text-primary mb-3">
              {esDesactivar
                ...
                : "¿Deseas activar nuevamente a este instructor?"}
            </p>
            <p className="mb-1">
